...
const fallbackLocations: Location[] = [
  ...
  },
  {
    ...
    description: { en: 'The city that never sleeps (wrong one?)', pl: 'Miasto, które nigdy nie śpi (nie to?)' },
    status: 'visited',
  },
  {
    _id: '4',
    ...
    description: { en: 'Sun, tapas, and good vibes', pl: 'Słońce, tapas i dobry vibe' },
    status: 'visited',
  },
  {
    _id: '5',
    ...
    description: { en: 'Pastéis de nata and Atlantic views', pl: 'Pastéis de nata i widoki na Atlantyk' },
    status: 'visited',
  },
];
